...
C	===============================================================
	...
	subroutine myrecfast(red,Temp,inpOmegaB,inpOmegaC,inpOmegaL,
     &                   inpHOinp,inpTnow,inpYp)
...
C	--- Commons
	common/azLIST/zinitial,zfinal,Nz
	common/aCfund/C,k_B,h_P,m_e,m_H,not4,sigma,a,Pi
	common/aCdata/Lambda,H_frac,CB1,CDB,CR,CK,CL,CT,
	1	fHe,CB1_He1,CB1_He2,CDB_He,Lambda_He,Bfact,CK_He,CL_He,fu
	common/aHemod/b_He,A2P_s,A2P_t,sigma_He_2Ps,sigma_He_2Pt,
	1	L_He_2p,L_He_2Pt,L_He_2St,L_He2St_ion
	common/aHmod/AGauss1,AGauss2,zGauss1,zGauss2,wGauss1,wGauss2
	common/aSwitch/Heswitch,Hswitch

	common/aCosmo/Tnow,HO,Nnow,z_eq,OmegaT,OmegaL,OmegaK
C	===============================================================
...
C	dimensions for integrator
	...
	Tnow = inpTnow
	Yp = inpYp
c    print *, OmegaB,OmegaC,OmegaL,Tnow,Yp
...
c	Set initial matter temperature
	...
	call aget_init(z,x_H0,x_He0,x0)
...
C He is 99% singly ionized, and *then* switch to joint H/He recombination.
	...
	1	- CB1/(Tnow*(1.d0+z)) ) / Nnow
	    ...
	    call ADVERK(nw,AION,zstart,y,zend,tol,ind,cw,nw,w)
	    y(1) = x_H0
	    x0 = y(1) + fHe*y(2)
...
c      write(7,'(1x,f8.2,3(2x,g15.8))')   zend,x,Tmat,Trad
...
C	===============================================================
	subroutine AGET_INIT(z,x_H0,x_He0,x0)
...
C===============================================================================
      subroutine ADVERK (n, fcn, x, y, xend, tol, ind, c, nw, w)
      integer n, ind, nw, k
...
c  begin abort action
  500 continue
c
c     write(*,505) ind, tol, x, n, c(13), xend, nw, c(16), c(20),

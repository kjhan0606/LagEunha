...
set multiplot layout 4,6 title 'Sod Shock Tube (N=200)' font ',14'
...
set yrange [0.044168:1.07975]
plot 'sod/ref.dat' u 1:2 w l lw 2 lc rgb '#000000' t 'Ref', \
     'sod/ns_av.dat' u 1:2 w p pt 2 ps 1.0 lw 2 lc rgb '#ff7f00' t 'NS+AV'

unset title
set ylabel 'Velocity'
set xlabel 'x'
set xrange [0:1]
set yrange [-0.0940922:1.1284]
...
set yrange [-0.0940922:1.1284]
plot 'sod/ref.dat' u 1:3 w l lw 2 lc rgb '#000000' t 'Ref', \
     'sod/ns_av.dat' u 1:3 w p pt 2 ps 1.0 lw 2 lc rgb '#ff7f00' t 'NS+AV'
...
set yrange [0.0266245:1.08443]
plot 'sod/ref.dat' u 1:4 w l lw 2 lc rgb '#000000' t 'Ref', \
     'sod/ns_av.dat' u 1:4 w p pt 2 ps 1.0 lw 2 lc rgb '#ff7f00' t 'NS+AV'
...
set yrange [1.58106:3.14553]
plot 'sod/ref.dat' u 1:5 w l lw 2 lc rgb '#000000' t 'Ref', \
     'sod/ns_av.dat' u 1:5 w p pt 2 ps 1.0 lw 2 lc rgb '#ff7f00' t 'NS+AV'

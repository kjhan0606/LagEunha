...
plot 'collision/ref.dat' u 1:3 w l lw 2 lc rgb '#000000' t 'Ref', \
     'collision/hllc_cd10.dat' u 1:3 w p pt 2 ps 1.0 lw 2 lc rgb '#a65628' t 'HLLC+CD10'
...
set yrange [-13.4438:22.045]
plot 'collision/ref.dat' u 1:3 w l lw 2 lc rgb '#000000' t 'Ref', \
     'collision/hllc_price.dat' u 1:3 w p pt 2 ps 1.0 lw 2 lc rgb '#377eb8' t 'HLLC+Price'
...
set yrange [-13.4438:22.045]
plot 'collision/ref.dat' u 1:3 w l lw 2 lc rgb '#000000' t 'Ref', \
     'collision/price.dat' u 1:3 w p pt 2 ps 1.0 lw 2 lc rgb '#e41a1c' t 'Price AV'
...
set yrange [-13.4438:22.045]
plot 'collision/ref.dat' u 1:3 w l lw 2 lc rgb '#000000' t 'Ref', \
     'collision/voronoi.dat' u 1:3 w p pt 2 ps 1.0 lw 2 lc rgb '#4daf4a' t 'Vor M(3,4)+dpZ'
...
plot 'collision/ref.dat' u 1:5 w l lw 2 lc rgb '#000000' t 'Ref', \
     'collision/hllc_cd10.dat' u 1:5 w p pt 2 ps 1.0 lw 2 lc rgb '#a65628' t 'HLLC+CD10'
...
set yrange [0:416.777]
plot 'collision/ref.dat' u 1:5 w l lw 2 lc rgb '#000000' t 'Ref', \
     'collision/hllc_price.dat' u 1:5 w p pt 2 ps 1.0 lw 2 lc rgb '#377eb8' t 'HLLC+Price'
...
set yrange [0:416.777]
plot 'collision/ref.dat' u 1:5 w l lw 2 lc rgb '#000000' t 'Ref', \
     'collision/price.dat' u 1:5 w p pt 2 ps 1.0 lw 2 lc rgb '#e41a1c' t 'Price AV'
...
set yrange [0:416.777]
plot 'collision/ref.dat' u 1:5 w l lw 2 lc rgb '#000000' t 'Ref', \
     'collision/voronoi.dat' u 1:5 w p pt 2 ps 1.0 lw 2 lc rgb '#4daf4a' t 'Vor M(3,4)+dpZ'

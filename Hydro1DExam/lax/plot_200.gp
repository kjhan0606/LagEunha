...
set multiplot layout 4,6 title 'Lax Shock Tube (N=200)' font ',14'
...
set yrange [0:1.60099]
plot 'lax/ref.dat' u 1:2 w l lw 2 lc rgb '#000000' t 'Ref', \
     'lax/ns_av.dat' u 1:2 w p pt 2 ps 1.0 lw 2 lc rgb '#ff7f00' t 'NS+AV'
...
set yrange [-1.00896:2.53768]
plot 'lax/ref.dat' u 1:3 w l lw 2 lc rgb '#000000' t 'Ref', \
     'lax/ns_av.dat' u 1:3 w p pt 2 ps 1.0 lw 2 lc rgb '#ff7f00' t 'NS+AV'
...
set yrange [0:3.80905]
plot 'lax/ref.dat' u 1:4 w l lw 2 lc rgb '#000000' t 'Ref', \
     'lax/ns_av.dat' u 1:4 w p pt 2 ps 1.0 lw 2 lc rgb '#ff7f00' t 'NS+AV'
...
set yrange [0:21.322]
plot 'lax/ref.dat' u 1:5 w l lw 2 lc rgb '#000000' t 'Ref', \
     'lax/ns_av.dat' u 1:5 w p pt 2 ps 1.0 lw 2 lc rgb '#ff7f00' t 'NS+AV'

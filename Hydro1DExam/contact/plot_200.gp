...
set multiplot layout 4,6 title 'Stationary Contact (N=200)' font ',14'
...
set yrange [0:1.551]
plot 'contact/ref.dat' u 1:2 w l lw 2 lc rgb '#000000' t 'Ref', \
     'contact/ns_av.dat' u 1:2 w p pt 2 ps 1.0 lw 2 lc rgb '#ff7f00' t 'NS+AV'
...
set yrange [-0.058:0.058]
plot 'contact/ref.dat' u 1:3 w l lw 2 lc rgb '#000000' t 'Ref', \
     'contact/ns_av.dat' u 1:3 w p pt 2 ps 1.0 lw 2 lc rgb '#ff7f00' t 'NS+AV'
...
set yrange [0.942604:1.04985]
plot 'contact/ref.dat' u 1:4 w l lw 2 lc rgb '#000000' t 'Ref', \
     'contact/ns_av.dat' u 1:4 w p pt 2 ps 1.0 lw 2 lc rgb '#ff7f00' t 'NS+AV'
...
set yrange [0:23.0342]
plot 'contact/ref.dat' u 1:5 w l lw 2 lc rgb '#000000' t 'Ref', \
     'contact/ns_av.dat' u 1:5 w p pt 2 ps 1.0 lw 2 lc rgb '#ff7f00' t 'NS+AV'

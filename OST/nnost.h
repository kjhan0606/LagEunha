...
int Find_Near(particle *,int ,TStruct *, TPtlStruct *,PosType *, TPtlStruct **);
/*
int Find_Near2(particle *,int ,TStruct *, TPtlStruct *,float *, TPtlStruct **);
*/
int Find_Near2(particle *, int , TStruct *, TPtlStruct *, size_t , PosType *, TPtlStruct **);
int Direct_Find_Near(particle *,int , TPtlStruct *,int, PosType *, TPtlStruct **);

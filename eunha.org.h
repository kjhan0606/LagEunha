...
#define GAS_SPHFLAG(simpar) ((simpar)->physics.gasinfo.flag.sphflag)
...
#define KH_INITTEMP(simpar) ((simpar)->simmodel.kh.InitTemp)
#define KH_MU(simpar) ((simpar)->simmodel.kh.mu)
...
#define IndT_NSUBSPH(simpar) ((simpar)->timeinfo.indt.nsubsph)
...
#define WLAM1(simpar) 	((simpar)->simmodel.cosmos.de.wlam1)

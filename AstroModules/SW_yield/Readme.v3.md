...
+-- stellar_wind_lib.h     # Main library header with API declarations
+-- stellar_wind_lib.c     # Implementation
+-- massive_yields.h       # Massive star wind yields (Limongi & Chieffi 2018)
+-- agb_yields.h           # AGB star yields (Karakas & Lugaro 2016)
+-- test_stellar_wind.c    # Test and demonstration program
+-- Makefile               # Build system
+-- libstellar_wind.a      # Compiled static library
```

## Yield Table Coverage

### Massive Stars (massive_yields.h)
Source: Limongi & Chieffi (2018), ApJS, 237, 13

| [Fe/H] | Z | Mass Range |
|--------|---|------------|
| 0 | 0.02 | 13-120 M_sun |
| -1 | 0.002 | 13-120 M_sun |
| -2 | 0.0002 | 13-120 M_sun |
| -3 | 0.00002 | 13-120 M_sun |

### AGB Stars (agb_yields.h)
Source: Karakas & Lugaro (2016), ApJ, 825, 26

| Z | [Fe/H] | Mass Range |
|---|--------|------------|
| 0.007 | ~-0.3 | 1.0-7.5 M_sun |
| 0.014 | 0 (solar) | 1.0-8.0 M_sun |
| 0.03 | ~+0.35 | 1.0-8.0 M_sun |

...
Voro2D_point *rt_Voro2D_FindNeighbor(SimParameters *, int , int , int *, treevorork4particletype *);
treevorork4particletype *rt_Voro2D_FindCellBP(SimParameters *, int , int , int *, treevorork4particletype *);
...
treevorork4particletype *rt_mkinitial(SimParameters *, int *);

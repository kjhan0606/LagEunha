...
! inserted by kjhan
        ...
        Transfer_clxcdot = 15, &! dD/dtau for cdm
        Transfer_clxbdot = 16 ! dD/dtau for baryon
!-----------------
    !Sources
